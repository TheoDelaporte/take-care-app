...
import '../accueil_page/accueil_page.dart'; // ignore_for_file: must_be_immutable

// ignore_for_file: must_be_immutable
class AccueilContainerScreen extends StatelessWidget {
  AccueilContainerScreen({Key? key})
      : super(
          key: key,
        );
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        body: Navigator(
          key: navigatorKey,
          initialRoute: AppRoutes.accueilPage,
